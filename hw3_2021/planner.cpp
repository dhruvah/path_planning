...
class SymPlan
{
    ...
    list<list<string>> Permutations(int n, unordered_set<string> syms)
    {
        ...
        Combinations(n, temp_perm, perm, syms);
        return perm;
    ...
    void AllGroundedActions()
    {
        ...
        for (auto &action: Actions)
        {
            ...
            for(auto &gargs: permutations[no_args])
            {
                ...
                //     cout << action << endl;
                // }
                // cout << "Size of all grounded actions = "<< allGroundedActions.size() << endl;
            }
        }   
    }
    ...
    void AStar()
    {
        ...
        unordered_map<State*, bool> CLOSED1;
        ...
        cout << "Heuristic Value Start = " << start->h_val << endl;
        start->f_val = 0;
        int stateID = 0;
        start->state_id = stateID;
        start->parent = 0;
        ...
        // cout << "Current State Parent = " << current_state->parent << endl;
